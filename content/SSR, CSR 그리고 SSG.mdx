...
![image](https://imagedelivery.net/0ls7rUWRjBE8C2UFoz_eSw/2f3e53a2-ba3d-44ee-9eec-6cf050159200/post)
...
# 2. SSR/CSR 렌더링 방식
![image](https://imagedelivery.net/0ls7rUWRjBE8C2UFoz_eSw/8fcc75c4-b548-4c21-29ad-e19194db1f00/post)
SSR(Sever Side Rendering)

브라우저가 요청한 HTML 파일을 서버에서 렌더링을 마친 후 반환하기 때문에 로딩 시간이 짧다. 그럼에도 JS 파일을 다운받고 적용하는 동안 인터랙션 할 수 없다는 사실을 유의.

![image](https://imagedelivery.net/0ls7rUWRjBE8C2UFoz_eSw/a7c93984-a53a-40d1-57c6-34c3f55a7300/post)
CSR(Client Side Rendering)

하나의 페이지에서 여러 페이지를 보여준다는 것은 자바스크립트를 이용해서 페이지의 일부 혹은 전체를 갈아치우는 것이다. 여러 개의 .js파일이 하나의 거대한 .js파일로 번들링되어 SPA를 이룬다고 보아도 무방하다.

![image](https://imagedelivery.net/0ls7rUWRjBE8C2UFoz_eSw/908a0342-15b6-4b30-11ea-e9d92c692b00/post)
...
![image](https://imagedelivery.net/0ls7rUWRjBE8C2UFoz_eSw/7b604ed0-8ab2-4e1e-eca4-031e83a6ca00/post)
![image](https://imagedelivery.net/0ls7rUWRjBE8C2UFoz_eSw/b382bf51-eb2e-4770-c7e3-6bac54c7c500/post)
