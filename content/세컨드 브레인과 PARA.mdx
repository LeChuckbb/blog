...
%% 정보 수집의 의의) 
- [[학습했다는 것은 새로운 정보를 기존 정보와 연결했다는 뜻이다]]
- [[하나의 정보에 유의미한 맥락을 최대한 많이 연결하라]]
- [[연상 그물망이 풍성하면 다른 정보와의 연결 가능성을 높일 수 있다]]%%
...
%% 정보 수집 팁)
- [[정보를 과하게 보관하지 않는 법, 나를 놀라게 하는 정보만 메모하라]]
- [[메모의 수집과 정리를 분리하라. 메모 수집을 위해 Inbox를 활용하라]]%%
...
%%- [[실행을 목적으로 메모를 수집하라. 정리를 목적으로 수집하면 안 된다]]%%
...
%%- [[메모를 저장하기 위한 완벽한 장소는 없다. 고민하지 말고 찾지도 말라]]%%
...
%%[](선형적이고%20계층적인%20폴더%20구조는%20메모%20간%20연결을%20방해한다.md)]]
- [[MOC는 태그와 폴더의 장점을 합쳐서 비선형적으로 동작한다]]%%
...
![[Pasted image 20240410205957.png]]
...
%%[](글쓰기는%20그%20자체가%20피드백%20루프이며,%20자기%20객관화를%20돕는다.md)]]
...
%%[](창의력의%20산물은%20항상%20새롭지만,%20창의적인%20과정은%20오래되었고%20변하지%20않는다.md)]]
- [[모든 창조의 과정에서는 발산과 융합이라는 동일한 패턴이 관측된다]]
- [[발산과 융합의 시점을 적절히 조절하여 작업완료 시점을 뒤로 미루는 일 없도록 하라]]%%
# PARA
%%- [[JIRA - PARA의 유사성]]%%
...
![[Pasted image 20230929140506.png]]
