...
이 문제를 비롯해서 몇몇 의견을 개진했다. React 18의 선언형 패러다임을 적용하면서 `<ErrorBoundary>`를 활용하게 되었다. 이 때 fallback UI 처리를 위해서 데이터 요청에는 성공했으나 빈 값일 때 실패가 아닌 성공으로 간주되게끔 변경을 요청했다. ([데이터가 없을 때 200인가 404인가?](https://techblog.yogiyo.co.kr/%EB%8D%B0%EC%9D%B4%ED%84%B0%EA%B0%80-%EC%97%86%EC%9D%84-%EB%95%8C-200%EC%9D%B8%EA%B0%80-404%EC%9D%B8%EA%B0%80-f1c8c39ca9df))
