      ...
      <AnimatePresence>
        {visible && !open && (
          <motion.button
            ...
            className="fixed bottom-6 left-6 z-50 flex h-10 max-w-[calc(100%-100px)] items-center gap-2 rounded-lg border border-border bg-background/80 px-3 backdrop-blur-sm text-foreground active:scale-95"
          >
